...
**レベルスキップ**
- 目標レベルのピースが**全て在庫切れ**の場合、さらに先のレベルのピースと交換可能
- レベルアップ例: Lv2→Lv3にアップグレードしたいが、Lv3（i3, v3）が両方在庫切れの場合、Lv4のピースと交換可能
- レベルダウン例: Lv4→Lv3にダウングレードしたいが、Lv3が両方在庫切れの場合、Lv2やLv1と交換可能
- 複数レベルが連続して在庫切れの場合、在庫があるレベルまでスキップ可能
...
**黒パズルの山札が枯渇**すると**最終ラウンド**に突入。

最終ラウンドでは、全員が1ターンずつプレイして通常ラウンド終了。
